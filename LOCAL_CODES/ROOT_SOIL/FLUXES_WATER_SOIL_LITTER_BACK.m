function [VARIABLES] = FLUXES_WATER_SOIL_LITTER_BACK (VARIABLES, VERTSTRUC, PARAMS, CONSTANTS, si)
...
net_qinflL = VARIABLES.SOIL.net_qinflL(si);                                    % [mm/s] 
...
if volliqli <= PARAMS.Soil.thetamin
...
VARIABLES.SOIL.qback_lit(si) = qback_lit;                                     % [mm/s] Real flux that is going back to snow-liter pack. 
