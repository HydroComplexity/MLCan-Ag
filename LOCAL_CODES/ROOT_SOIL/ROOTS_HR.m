function [rpp, rpp_weight, krad, kax] = ROOTS_HR( SWITCHES, VERTSTRUC, PARAMS, VARIABLES, si)
...
%*************************************************************************
    ...
    smp = VARIABLES.SOIL.smp(:, si);
    vol_liq = VARIABLES.SOIL.volliq(:, si);
    ...
    K_rad = PARAMS.Soil.K_rad(si);
    K_axs = PARAMS.Soil.K_axs(si);
%*************************************************************************
%*************************************************************************
