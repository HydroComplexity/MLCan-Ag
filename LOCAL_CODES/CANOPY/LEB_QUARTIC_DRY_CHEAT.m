...
%    vinds = vinds_all{cntspecies}; 
    ...
    eaz = VARIABLES.CANOPY.EAz(:,cntspecies);                                            % [kPa] Vapor Pressure Air, for all layers 
    Taz = VARIABLES.CANOPY.TAz(:,cntspecies);                                            % [C] Air Temperature, for all layers 
...
%     T4(isinf(T4)|isnan(T4)) = Taz;
%     T3(isinf(T3)|isnan(T3)) = Taz;
%     T2(isinf(T2)|isnan(T2)) = Taz;
%     T1(isinf(T1)|isnan(T1)) = Taz;
%     T0(isinf(T0)|isnan(T0)) = Taz;
