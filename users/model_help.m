...
get_start_txt    = ['Multi-layers Canopy Soil Model (MLCan) brief description:                 '         char(10), ...
                    '       '                                                           char(10), ...
                    '       '                                                           char(10), ...            
...
model_setup_txt = [ 'VEGETATION: Number and name of vegetations simulated              '       char(10), ...
                    '       '                                                                                       char(10), ...            
                    ...
                    '       '                                                                                       char(10), ...                                           
                    'SPECIFIED DOY: Days of year chosen for start simulation                                '       char(10), ...                                
                    '       '                                                                                       char(10), ...   
                    '       '                                                                                       char(10), ...
                    'PHOTOSYNTHESIS: Type of photosynthesis for simulated vegetation                        '       char(10), ...                                                                                       char(10), ...                                
                    '       '                                                                                       char(10), ...
...
option_txt =       ['SPECIES: Number of species simulated                                                   '       char(10), ...                                          
                    '       '                                                                                       char(10), ...
                    'ROOT HYDRAULIC CONDUCTIVITY (RHC): Increase of RHC along with soil depth               '       char(10), ...                            
                    '       '                                                                                       char(10), ...
                    'CLIMATE CHANGE                                                                         '       char(10), ...
                    '    Carbon dioxide concentration:                                                      '       char(10), ...            
                    '       Ambient: Current condition, default value is set 390 [ppm]                      '       char(10), ...
                    '       Elevated: Value of CO2 concentration is increased due to global warming         '       char(10), ...  
                    '    Temperature change:                                                                '       char(10), ...            
                    '       Ambient: Current condition                                                      '       char(10), ...
                    '       Elevated: Atmospheric temeprature is increased due to global warming            '       char(10), ...                  
                    '       '                                                                                       char(10), ... 
                    'SOIL NUTRIENT MODEL: Check to include soil nitrogen dynamics                           '       char(10), ...                     
                    '       '                                                                                       char(10), ...         
...
initial_txt =      ['   Initial conditions for soil moisture, soil heat, and soil carbon and nitrogen are required'       char(10), ...
                    '       '                                                                                       char(10), ...                                                    
                    '       '                                                                                       char(10), ...                                                    
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
load './Temps/temp_model.mat' 'get_start_txt'
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
load './Temps/temp_model.mat' 'model_setup_txt'
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
load './Temps/temp_model.mat' 'option_txt'
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
load './Temps/temp_model.mat' 'forcing_txt'
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
load './Temps/temp_model.mat' 'initial_txt'
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
load './Temps/temp_model.mat' 'result_txt'
