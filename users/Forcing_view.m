...
load './Temps/temp_model.mat' 'working_forcings' 'num_species' 'Soil_nutrient' 'N_Uptake_RB'
...
if Soil_nutrient == 1
    if N_Uptake_RB == 1
        dat_forcing=[year_crop, month_crop, day_crop, doy_crop, hour_crop,  ...
            ...
            LMI_species1_crop, LMI_species2_crop, LMI_species3_crop, LMI_species4_crop, management_crop];        
        ...
        forcing_str = {...
            ...
            'Root biomass for species 1 [g/m2]','Root biomass for species 2 [g/m2]','Root biomass for species 3 [g/m2]','Root biomass for species 4 [g/m2]', 'planting and harvesting date'};
...
elseif Soil_nutrient == 0
    dat_forcing=[year_crop, month_crop, day_crop, doy_crop, hour_crop,  ...
        Ta_crop, Pa_crop, Rg_crop, PPT_crop, VPD_crop, U_crop, ustar_crop, ...
        LAI_species1_crop, LAI_species2_crop, LAI_species3_crop, LAI_species4_crop, management_crop];
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
load './Temps/temp_model.mat' 'Soil_nutrient' 'N_Uptake_RB'
%
if Soil_nutrient == 1
    if N_Uptake_RB == 1
...
if Soil_nutrient == 1
    if N_Uptake_RB == 1
        ...
        management_crop       = dat_forcing(:,29);
        
        load './Temps/temp_model.mat' 'working_forcings'
        save(working_forcings, ...
            ...
            'BMla_species1_crop', 'BMla_species2_crop', 'BMla_species3_crop', 'BMla_species4_crop', ...
            'CNratio_species1_crop', 'CNratio_species2_crop', 'CNratio_species3_crop', 'CNratio_species4_crop', ...
            'LMI_species1_crop' , 'LMI_species2_crop' , 'LMI_species3_crop' , 'LMI_species4_crop', 'management_crop', '-append');
    elseif N_Uptake_RB == 0
        year_crop         = dat_forcing(:,1);
        month_crop        = dat_forcing(:,2);
        day_crop          = dat_forcing(:,3);
        ...
        management_crop         = dat_forcing(:,37);
        ...
        save(working_forcings, ...
            ...
            'CNratioA_species1_crop','CNratioA_species2_crop','CNratioA_species3_crop','CNratioA_species4_crop', ...
            'CNratioB_species1_crop','CNratioB_species2_crop','CNratioB_species3_crop','CNratioB_species4_crop', ...
            'NDEM_species1_crop','NDEM_species2_crop','NDEM_species3_crop','NDEM_species4_crop' , 'management_crop', '-append');
...
elseif Soil_nutrient == 0
    ...
    management_crop   = dat_forcing(:,17);
    ...
    save(working_forcings, ...
        'year_crop', 'doy_crop', 'hour_crop', 'day_crop', 'month_crop', ...
        'LAI_species1_crop', 'LAI_species2_crop', 'LAI_species3_crop', 'LAI_species4_crop', 'Ta_crop', ...
        'U_crop', 'Rg_crop', 'PPT_crop', 'VPD_crop', 'Pa_crop', 'ustar_crop', 'management_crop', '-append');
end
...
% handles    structure with handles and user data (see GUIDATA)
%
load './Temps/temp_model.mat' 'working_forcings' 'num_species' 'DOY_start' 'DOY_end' 'Soil_nutrient' 'N_Uptake_RB'
load(working_forcings);
